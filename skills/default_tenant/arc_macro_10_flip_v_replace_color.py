"""Exported ARC DSL macro 'macro_10_flip_v_replace_color' with operations: [('flip_v', []), ('replace_color(1, 2)', [1, 2])]"""
"""Standalone ARC DSL Macro: macro_10_flip_v_replace_color"""
